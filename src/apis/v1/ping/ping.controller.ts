...
class PingController {
  ...
  static getProvinces = (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
    const provinces = [
      {
    ...
    return res.status(200).json({ success: true, message: "provinces", payload: { provinces }, error: null });
  };
}
